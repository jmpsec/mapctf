...
// TestExistsGetByUUID tests ExistsGet with explicit UUID values.
func TestExistsGetByUUID(t *testing.T) {
	...
	// Check entity 1
	exists, team = manager.ExistsGet("Entity Team", testUUID1)
	if !exists {
	...
	// Check entity 2
	exists, team = manager.ExistsGet("Entity Team", testUUID2)
	if !exists {
	...
	exists, team = manager.ExistsGet("Entity Team", "non-existent-uuid")
	if exists {
